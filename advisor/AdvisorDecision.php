    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label for="eventvenue" class="form-label">Main Venue</label>
                    <textarea class="form-control readonly"
                        readonly><?php echo $proposal['MainVenue'] ?? 'N/A'; ?></textarea>
                </div>

                <div class="mb-3">
                    <label for="altvenue" class="form-label">Alternative Venue</label>
                    <textarea class="form-control readonly"
                        readonly><?php echo $proposal['AltVenue'] ?? 'N/A'; ?></textarea>
                </div>

                <div class="mb-3">
                    <label for="altdate" class="form-label">Alternative Date</label>
                    <textarea class="form-control readonly"
                        readonly><?php echo $proposal['Ev_AlternativeDate'] ?? 'N/A'; ?></textarea>
                </div>

                <h5 class="section-header">Additional Information File</h5>
                <div class="mb-3">
                    <label class="form-label">Uploaded Document</label><br>
                    <?php if (!empty($proposal['Ev_AdditionalInfo'])): ?>
                        <a href="viewpdf.php?file=<?php echo urlencode($proposal['Ev_AdditionalInfo']); ?>" target="_blank"
