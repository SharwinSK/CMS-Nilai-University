...
if ($type === 'proposal') {
    ...
    SELECT 
        ...
        e.Ev_Intro, e.Ev_Details, e.Ev_Date, e.Ev_StartTime, e.Ev_EndTime, e.Ev_Pax,
    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label class="form-label">Main Venue</label>
                    <input type="text" class="form-control"
                        value="<?php echo $details['MainVenue'] ?? 'Not specified'; ?>" readonly>
                </div>

                <div class="mb-3">
                    <label class="form-label">Alternative Venue</label>
                    <input type="text" class="form-control"
                        value="<?php echo $details['AltVenue'] ?? 'Not specified'; ?>" readonly>
                </div>

                <div class="mb-3">
                    <label class="form-label">Alternative Date</label>
                    <input type="date" class="form-control" value="<?php echo $details['Ev_AlternativeDate'] ?? ''; ?>"
                        readonly>
                </div>

                <?php if (!empty($details['Ev_AdditionalInfo'])): ?>
                    <div class="mb-3">
                        <label class="form-label">Additional Document</label><br>
                        <a href="<?php echo htmlspecialchars($details['Ev_AdditionalInfo']); ?>" target="_blank"
