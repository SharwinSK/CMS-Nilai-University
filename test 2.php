      ...
      <form method="POST" enctype="multipart/form-data" action="ProposalHandler.php?mode=create">
        ...
        <div class="section">
          ...
          <div class="form-group">
            ...
            <textarea id="eventIntroduction" name="eventIntroduction" style="min-height: 200px" required></textarea>
          ...
          <div class="form-row">
            <div class="form-col">
              <div class="form-group">
                ...
                <input type="number" id="estimatedParticipants" name="estimatedParticipants" min="1" required />
          ...
          <div class="form-group">
            ...
            <div class="upload-area" id="posterUpload">
              <div>
                ...
                <input type="file" id="eventPoster" name="eventPoster" accept=".jpg,.jpeg,.png" style="display: none"
                  required />
              </div>
            </div>
            <div class="file-info">
