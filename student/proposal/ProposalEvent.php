...
$venues = $conn->query("SELECT Venue_ID, Venue_Name FROM venue ORDER BY Venue_Name");
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="ProposalSubmit.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="inputVenue" class="form-label">Main Venue</label>
                        <select class="form-select" id="inputVenue" name="ev_venue_id" required>
                            <option value="">-- Select Main Venue --</option>
                            <?php
                            $venues->data_seek(0); // Reset result pointer
                    ...
                    <div class="mb-3">
                        <label for="altVenue" class="form-label">Alternative Venue</label>
                        <select class="form-select" id="altVenue" name="ev_alt_venue_id">
                            <option value="">-- Select Alternative Venue --</option>
                            <?php
                            $venues->data_seek(0); // Reset again for reuse
                            while ($venue = $venues->fetch_assoc()) {
                                echo "<option value='{$venue['Venue_ID']}'>{$venue['Venue_Name']}</option>";
                            }
                            ?>
                    ...
                    <div class="mb-3">
                        <label for="altDate" class="form-label">Alternative Date</label>
                        <input type="date" name="ev_alt_date" id="altDate" class="form-control">
                    </div>

                    <div class="mb-3">
                        <label for="additionalInfo" class="form-label">Additional Information (PDF/DOC)</label>
                        <input type="file" class="form-control" name="ev_additional_info" accept=".pdf,.doc,.docx">
                    </div>
